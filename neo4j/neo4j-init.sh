...
if [ ! -f /tmp/neo4j-import-done.flag ]; then
    ...
    /var/lib/neo4j/bin/neo4j-import --into /var/lib/neo4j/data/databases/graph.db --delimiter '\t' --nodes /neo4j/graph_complex_all4.neo.nodes --relationships /neo4j/graph_complex_all4.neo.edges 
