...
$PYTHON3 `dirname $0`/complex_graph_desc_all.py $@ > `pwd`/graph_complex_all2.pg
sort graph_complex_all2.pg | uniq > graph_complex_all2_uniq.pg
$PG2NEO `pwd`/graph_complex_all2_uniq.pg
