...
for item in sys.argv[1:]:
    ...
    for _, row in e2r.iterrows():
        ...
        node = [str(i+1), ":person"] if (props["category"] != "入社意思確定" and props["category"] != "07da9a3b2054dcaf92b695d4ab55bad29bc18c0c7b26de25f9f1bb86cf2513f3" and props["category"] != "dc42f4638f80ae5dc1a5ddaf2e4edfdee6577407b4e0bf6a1a23c8b2b90b6202" and props["category"] != "5cd05332ceec0f70e816e2a698345f7f8f9e4feaf33e6272f1c6236dbcec1af5"
        and props["category"] !=
        "987e0dab1fe8551842fe8662b87becaee41ef1d2471ef7bc7bba4b2a6e21e8fc") else [str(i+1), ":candidate"]
