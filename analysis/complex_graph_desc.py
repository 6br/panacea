...
for item in sys.argv[1:]:
    ...
    for _, row in e2r.iterrows():
        ...
        node = [str(i+1), ":person"] if (props["category"] != "入社意思確定" and props["category"] != "07da9a3b2054dcaf92b695d4ab55bad29bc18c0c7b26de25f9f1bb86cf2513f3") else [str(i+1), ":candidate"]
